...
You can adjust the output using the four different options in the `_targets.R`
script after the Targets section. The options include:
...
{targets} looks for the last declared list of targets in the `_targets.R` file. 
